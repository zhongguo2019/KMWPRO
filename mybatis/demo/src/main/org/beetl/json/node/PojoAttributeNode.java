...
//				w.writeValue(null);
            ...
            switch (methodProxy.returnType) {
                ...
                case Type.Collection_TYPE: {
                    NodeUtil.writeIterator(this, atrrKey == null ? new OutputNodeKey(strKey) : atrrKey, ((Iterable) attrValue), w);
                    return;
                }
                case Type.MAP_TYPE:
                    NodeUtil.writeMap(this, atrrKey == null ? new OutputNodeKey(strKey) : atrrKey, (Map) attrValue, w);
                    return;
                case Type.POJO_TYPE: {
                    w.getTool().serializeJW(w, atrrKey == null ? new OutputNodeKey(strKey) : atrrKey, attrValue, this.inHeritedPolicy);
                    return;
                }
                default: {

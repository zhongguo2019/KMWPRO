...
public class OrganController extends BaseController {
    ...
    public @ResponseBody
    List<SysOrgan> getOrganTreeList(@ModelAttribute SysOrgan sysOrgan) {
        logger.info("获取机构树");
        checkPermission("query");
    ...
    public @ResponseBody
    Result save(@ModelAttribute SysOrgan sysOrgan) {
    ...
    public @ResponseBody
    Result del(@RequestParam Map<String, Object> params, String id) {
        logger.info("开始删除机构");
...
//			area = sysAreaService.selectByPrimaryKey(organ.getAreaId());
    ...
    public @ResponseBody
    boolean checkName(@ModelAttribute SysOrgan organ) {

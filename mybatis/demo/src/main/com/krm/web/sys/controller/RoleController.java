...
public class RoleController extends BaseController {
    ...
    public @ResponseBody
    List<SysUser> organUser(String organId) {
    ...
    public @ResponseBody
    Result saveUserRole(@ModelAttribute SysRole sysRole) {
    ...
    public @ResponseBody
    Result save(@ModelAttribute SysRole sysRole) {
    ...
    public @ResponseBody
    Result saveOpRights(@ModelAttribute SysRolePermission sysRolePermission) {

...
chartdata.types.runData = {
    ...
    params: {
        ...
        statDateInterval: {
            ...
            required: true,
            type: 'select',
            options: [{name: '小时', value: '1h'}, {name: '天', value: '1d'}, {name: '周', value: '1w'}, {
                name: '月',
                value: '1M'
            }, {name: '季', value: '1q'}, {name: '年', value: '1y'}]
        },
        dateRange: {
            name: '时间范围',
            required: true,
            type: 'select',
            options: [{name: '过去一小时', value: 1}, {name: '过去一天', value: 24}, {
                name: '过去一周',
                value: 7 * 24
            }, {name: '过去一月', value: 30 * 24}, {name: '过去一季', value: 90 * 24}, {name: '过去一年', value: 365 * 24}]
        }
    },
    // 向图表中设置数据

    ...
    $.extend(true, myflow.config.tools.states, {
        ...
        task1: {
            ...
            props: {
                ...
                name: {
                    name: 'name', label: '步骤名称', value: '', editor: function () {
                        return new myflow.editors.inputEditor();
                    }
                },
                tableName: {
                    name: 'tableName', label: '中间表名', value: '', editor: function () {
                        return new myflow.editors.inputEditor();
                    }
                },
                stepDesc: {
                    name: 'stepDesc', label: '步骤描述', value: '', editor: function () {
                        return new myflow.editors.inputEditor();
                    }
                },
                sqlCode: {
                    name: 'sqlCode', label: 'SQL脚本', value: '', editor: function () {
                        return new myflow.editors.inputEditor();
                    }
                }
            }
        ...
        ,
        task4: {
            showType: 'image&text', type: 'task4',
            name: {text: ''},
            text: {text: '生成的最终结果'},

            ...
            <select class="${class!}" name="${name!}" id="${id!}" select="true">
                ...
                <select class="${class!}" name="${name!}" id="${id!}" disabled="disabled">
                    ...
                    <select class="${class!}" name="${name!}" id="${id!}">
                        ...
                        @}else{
                        @if(withNo == 'true'){
                        <option value="${dollar!}{op.value!}" ${dollar!}{decode(strutil.toString(op.value!
                        ""),strutil.toString(${tableName}.${name!}!""),"selected","")}>${dollar!}{op.value! }【${dollar!}{op.label!
                        }】</option>
                        @}else{
                        <option value="${dollar!}{op.value!}" ${dollar!}{decode(strutil.toString(op.value!
                        ""),strutil.toString(${tableName}.${name!}!""),"selected","")}>${dollar!}{op.label! }</option>
                        @}
                        @}
                        \@}
                        \@}

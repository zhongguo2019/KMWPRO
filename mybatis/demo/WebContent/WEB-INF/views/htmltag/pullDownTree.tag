...
<div class="btn-group ${class!}" style="width:${width};">
	<span data-toggle="dropdown" class="btn btn-primary btn-white dropdown-toggle width-100"
		...
		<span id="pullDownTreeCurName${order}">${rootNodeName}</span> <i
...
<script type="text/javascript">
    ...
    $(function () {
        $("div.dropdown-menu").on("click", ".ztree .switch,#pullDownTreeSearch${order},.scroll-track", function (e) {
            e.stopPropagation();
        });
        ...
        pullDownTreeSetting${order} = {
            view: {
                ...
                fontCss: function (treeId, treeNode) {
                    return (!!treeNode.highlight) ? {"font-weight": "bold", "color": "red"} : {
                        "font-weight": "normal",
                        "color": "#333"
                    };
                }

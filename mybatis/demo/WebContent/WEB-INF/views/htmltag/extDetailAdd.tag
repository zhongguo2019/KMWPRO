...
<table id="tb${random}" class="table table-bordered" data-toolbar="#toolbar" width="100%" style="white-space: nowrap;">
    ...
    <tr>
        ...
        <td style="text-align: center;">
            @if(detail.nullFlag == '0'){
            <select id="${detail.enName!}"
                    name="${detail.enName!}${decode(strutil.toString(detail.dataType!0),'03','Name','')}"
        ...
        <td style="text-align: center;">
            @if(detail.nullFlag == '0'){
            <input type="text" name="${detail.enName!}" onFocus="WdatePicker()" class="Wdate validate[required]"/>&nbsp;<font
        ...
        <td style="text-align: center;">
            ...
            <input type="text" name="${detail.enName!}" maxlength="11" onblur="chkvalue(this)"
                   placeholder="0.00(精度：两位小数)" class="money  validate[required]"/>&nbsp;<font color="red"
                                                                                              size="+1">*</font>
            @}else{
            <input type="text" name="${detail.enName!}" maxlength="11" onblur="chkvalue(this)" class="money"

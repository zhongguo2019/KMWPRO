...
{
    private String prefix = "metadata/datasource";

    @Autowired
    private IDataSourceService dataSourceService;
    protected Logger logger = LoggerFactory.getLogger(getClass());
    @RequiresPermissions("metadata:datasource:view")
    @GetMapping()
 ...
 *@function 查询数据源管理列表
 */
    @RequiresPermissions("metadata:datasource:list")
    @PostMapping("/list")
    @ResponseBody
...
*@function  导出数据源管理列表
*/
    @RequiresPermissions("metadata:datasource:export")
    @PostMapping("/export")
    @ResponseBody
...
*@function  新增保存数据源管理
*/
    @RequiresPermissions("metadata:datasource:add")
...
*@function 修改保存数据源管理
*/
    @RequiresPermissions("metadata:datasource:edit")
 ...
 */
	...
	public PageInfo<CommonEntity> PageInfo(@RequestParam Map<String, Object> params, Model model) {
		...
		PageInfo<CommonEntity> page = dataSourceService.queryPageInfoEntity(params);
		return page;
...
*/
	...
	public TableDataInfo tableDataInfo(@RequestParam Map<String, Object> params, Model model) {
		logger.info("【通用实体查询】 分页显示 数据源管理 ，Map参数：" + params.toString());
		List<CommonEntity> listEntity = dataSourceService.commonList(params);
...
*/
	...
	public CommonEntity queryOne(@RequestParam Map<String, Object> params, ModelMap mmap) {
		...
		CommonEntity commonEntity = dataSourceService.queryOne(params);
		return commonEntity;
...
*  @function 删除数据源管理
*/
    @RequiresPermissions("metadata:datasource:remove")
